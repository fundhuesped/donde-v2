...
const LegacyDataRecordSchema = z.object({
  ...
  [LegacyDataField.STREET]: z.union([z.string().min(1), z.number()]),
  [LegacyDataField.STREET_NUMBER]: z.union([z.string(), z.number()]).optional(),
  [LegacyDataField.APARTMENT]: z.union([z.string(), z.number()]).optional(),
  [LegacyDataField.INTERSECTION]: z.union([z.string(), z.number()]).optional(),
  [LegacyDataField.DETAILS]: z.string().optional(),
  [LegacyDataField.WEBSITE]: z.union([z.literal(''), z.string().url()]).optional(),
  [LegacyDataField.CITY]: z.string().min(1),
  [LegacyDataField.DEPARTMENT]: z.string().min(1),
  [LegacyDataField.PROVINCE]: z.string().min(1),
  [LegacyDataField.COUNTRY]: z.string().min(1),
  [LegacyDataField.PUBLISHED]: LegacyPublishedStatusSchema,
  [LegacyDataField.LATITUDE]: z.number(),
  [LegacyDataField.LONGITUDE]: z.number(),
