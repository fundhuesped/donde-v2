  ...
  return (
    <>
      ...
      <main className={'px-6 my-2 lg:mx-auto lg:max-w-desktop'}>
        ...
        <p className={'text-base text-justify mb-6'}>Fue creada por Fundación Huésped en 2013 desarrollada en varias etapas gracias al trabajo de muchas personas. El sitio actual fue hecho por Wingu.</p>
        <p>Es una plataforma de código abierto, disponible en:{' '} <FAQLink href=" https://github.com/fundhuesped/donde-huesped">Github</FAQLink></p>
