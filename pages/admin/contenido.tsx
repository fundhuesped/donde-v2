  ...
  return (
    <div ref={faqsRef} className="w-3/4 mx-auto">
      ...
      <div id="sobre-donde" className={activeTab === 'sobre-donde' ? '' : 'hidden'}>
        ...
        {aboutContent &&
          aboutContent.map((currentContent, index) => (
      ...
      <div id="faq" className={activeTab === 'faq' ? '' : 'hidden'}>
        <div className="flex justify-between">
          <h2 className="text-lg text-black font-bold my-2">FAQs</h2>
          <Button
            className={'my-3 p-0'}
            type={'secondary'}
              ...
              <div key={index}>
                <div>
                  <Tiptap
                    ...
                    callback={setFaqsSectionContent}
                    answer={faq.answer}
                    faqContent={faqContent}
                    onSetFaqContent={setFaqContent}
                  />
