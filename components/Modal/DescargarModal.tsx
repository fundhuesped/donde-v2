     ...
     <Modal bg={'bg-white'} width={'w-[32rem]'} rounded={'rounded-md'} showModal={showModal} className={'bg-neutral-600/50 '}>
          ...
          <div className="flex items-left justify-center flex-col px-12 py-1 pb-12 rounded-b ">
            <div className="w-full">
                ...
                Descargar criterios de la búsqueda
                </h2>
                <ul>
                    <li className='text-sm font-normal py-2'>Formato:</li>
                    <li className="flex items-center">
                        <input id="default-radio-1" type="radio" value="" name="default-radio" className="w-4 h-4 text-primary bg-gray-100 border-gray-300 focus:ring-primary focus:ring-2 "/>
                        <label htmlFor="default-radio-1" className="ml-2 text-sm text-gray-900">XLS</label>
                    </li>
                    <li className="flex items-center">
                        <input id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-primary bg-gray-100 border-gray-300 focus:ring-primary focus:ring-2 "/>
                        <label htmlFor="default-radio-2" className="ml-2 text-sm text-gray-900">CSV</label>
                    </li>
                    <li className="flex items-center">
                        <input id="default-radio-3" type="radio" value="" name="default-radio" className="w-4 h-4 text-primary bg-gray-100 border-gray-300 focus:ring-primary focus:ring-2 "/>
                        <label htmlFor="default-radio-3" className="ml-2 text-sm text-gray-900">XML</label>
                    </li>
                </ul>
