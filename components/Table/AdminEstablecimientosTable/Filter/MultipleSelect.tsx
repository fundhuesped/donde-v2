    ...
    <>
      <div className={`relative inline-block text-left w-full ${className}`}>
        <div>
          <button
            type="button"
            className={'mt-6 input-style w-full rounded-base h-12 rigth-0 text-sm text-gray-500 right-1'}
            id="menu-button"
            aria-expanded="true"
            aria-haspopup="true"
        ...
        {show && (
          <div
            className="absolute right-0 z-10 mt-1 w-full origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none max-h-[250px] overflow-y-auto scroll-style"
            role="menu"
